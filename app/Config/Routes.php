...
$routes->match(['get', 'post'], '/goods', 'GoodsController::index', ['filter' => 'auth']);
...
// Json Response
$routes->get('/goods/goods_list', 'GoodsController::goodsList', ['filter' => 'auth']);
$routes->post('/goods/goods_search', 'GoodsController::goodsSearch', ['filter' => 'auth']);
//End Json Response

// CRUD Restock
$routes->get('/restock', 'RestockController::index', ['filter' => 'auth']);
$routes->match(['get', 'post'], '/restock/create', 'RestockController::create', ['filter' => 'auth']);
$routes->get('/restock/edit/(:segment)', 'RestockController::edit/$1', ['filter' => 'auth']);
$routes->post('/restock/delete', 'RestockController::delete', ['filter' => 'auth']);
$routes->get('/restock/details/(:segment)', 'RestockController::details/$1', ['filter' => 'auth']);
$routes->post('/restock/cancle', 'RestockController::cancle', ['filter' => 'auth']);
// Delete and Restore
...
// Json Response
$routes->post('/restock/add_goods', 'RestockController::addGoods', ['filter' => 'auth']);
$routes->post('/restock/list_goods', 'RestockController::listGoods', ['filter' => 'auth']);
$routes->post('/restock/add_qty', 'RestockController::addQty', ['filter' => 'auth']);
$routes->post('/restock/delete_goods', 'RestockController::deleteGoods', ['filter' => 'auth']);
$routes->get('/restock/restock_list', 'RestockController::restockList', ['filter' => 'auth']);
$routes->post('/restock/restock_date', 'RestockController::getDate', ['filter' => 'auth']);
//End Json Response
