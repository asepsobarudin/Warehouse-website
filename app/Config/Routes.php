...
$routes->get('/restock/restock_details/(:segment)', 'RestockController::details/$1', ['filter' => 'auth:kasir,admin']);
...
$routes->post('/restock/rs_delete', 'RestockController::deleteGoods', ['filter' => 'auth:kasir,admin']);
...
$routes->post('/distribution/add_items', 'DistributionController::addItems', ['filter' => 'auth:gudang,admin']);