<div class="block w-full h-screen bg-white p-2 relative efectTrasition overflow-y-scroll scrollBar scrollBarBg scrollBarColors">
  ...
  <form action="<?= base_url('restock/create') ?>" method="post" class="block w-full h-full" id="form_add_restock">
    ...
    <div class="flex flex-col items-center justify-start gap-2 min-h-[410px] md:overflow-y-scroll scroll-smooth scrollBar scrollBarBg scrollBarColors overflow-hidden" id="restock_list_cart">
      <!-- List Cart Restock -->
    </div>
