...
<main class="container p-2" id="main">
  <div>
    <div class="flex w-full justify-between items-center mb-2">
      <h2 class="text-lg font-medium w-max">Request Barang</h2>
      <a href="#" class="p-2 bg-add hover:bg-addHover ease-in-out duration-100 rounded-md flex justify-center items-center gap-1">
