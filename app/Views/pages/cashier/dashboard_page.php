...
<main class="flex flex-col md:flex-row justify-between items-start after:contents-[''] after:block">
  <?= $this->include('components/navbar') ?>
  <div class="container h-[1000px]">
    <header class="flex flex-wrap justify-between items-center w-full p-1 gap-2">
