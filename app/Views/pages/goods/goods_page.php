...
<main class="container p-2" id="main">
  ...
  <div class="w-full flex justify-between items-center my-2 gap-2 flex-wrap">
    <div class="flex justify-center items-center gap-2 w-max">
      <img src="<?= base_url('assets/icons/box-line-black-1.svg') ?>" alt="box-line" class="w-[30px] h-[30px] object-cover">
  ...
  <div class="flex justify-between items-center gap-2">
    <div class="flex justify-center md:justify-end items-center min-w-[80%] md:min-w-[350px] gap-2">
      ...
      <button type="button" id="button_refresh" class="buttonWarning ml-1 px-2 py-1 w-max" onclick="GoodsPageList({url: '<?= site_url() ?>/goods/goods_list'})">
    ...
    <table class="table-auto w-full my-2">
      <thead>
        <tr>
          ...
          <td class="p-2 bg-primary text-secondary font-semibold text-center hidden lg:table-cell">
            Minimal
          </td>
